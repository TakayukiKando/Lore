...
public class EncodeFinder {
	 ...
	 * @throws IOException
	 */
	public static String findEncodeInfo(Path source, int scanLines, String defaultEncode) throws IOException {
//		System.err.println("source: \""+source.toString()+"\"");
		try(BufferedReader rd = new BufferedReader(new FileReader(source.toFile()));){
			String enc = null;
